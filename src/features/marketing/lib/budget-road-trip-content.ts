...
export const BUDGET_GUIDE = {
  ...
  intro: {
    ...
    soloGuideLink: {
      ...
      label: "Préparer aussi l’organisation d’un road trip solo",
    },
  },
  toc: [
