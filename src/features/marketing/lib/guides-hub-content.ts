...
export const GUIDES_HUB = {
  ...
  hero: {
    ...
    primaryCta: {
      href: "/guides#guides-publies",
      label: "Parcourir les guides",
    },
    secondaryCta: {
