  ...
  try {
    const trip = await createTrip(
      userId,
      {
        ...
        originPlaceId: draft.origin.placeId,
        originLatitude: draft.origin.latitude,
        originLongitude: draft.origin.longitude,
        originCity: draft.origin.city,
        originProvince: draft.origin.province,
        originPostalCode: draft.origin.postalCode,
        originCountry: draft.origin.country,
        destinationPlaceId: draft.destination.placeId,
        ...
        destinationProvince: draft.destination.province,
        destinationPostalCode: draft.destination.postalCode,
        destinationCountry: draft.destination.country,
