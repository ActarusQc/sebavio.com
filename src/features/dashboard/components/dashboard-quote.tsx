export function DashboardQuote() {
  return (
    <figure className="mx-auto max-w-3xl px-4 py-4 text-center">
      <blockquote className="text-client-text-muted text-sm leading-relaxed italic sm:text-base">
      ...
      <div className="mt-3 flex items-center justify-center gap-3" aria-hidden>
        ...
        <span className="text-client-star text-sm leading-none">★</span>
        <span className="bg-client-border h-px w-14 sm:w-20" />
      </div>
    </figure>
  );
